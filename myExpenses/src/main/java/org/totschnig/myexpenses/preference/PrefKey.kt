...
enum class PrefKey {
    ...
    DEBUG_SCREEN(R.string.pref_debug_key), DEBUG_LOGGING(R.string.pref_debug_logging_key),
    ...
    OCR(R.string.pref_ocr_key), EXCHANGE_RATES(R.string.pref_exchange_rates_key),
